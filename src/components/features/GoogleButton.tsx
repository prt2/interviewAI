...
export default function GoogleButton({ signIn }: IGoogleButtonProps) {
  return (
    <button
      onClick={signIn}
      className="flex w-full justify-center gap-3 rounded bg-white px-3 py-3 text-xs font-medium drop-shadow-md hover:bg-gray-50 text-black"
    >
